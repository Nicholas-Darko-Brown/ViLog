...
const AdminPage = () => {
  ...
  const fetchVisitorsData = async () => {
    ...
    setVisitors(data);
    console.log(data);
    const myJSON = JSON.stringify(data[5]);
    console.log(myJSON);
  };
  ...
  // add form submit
  const handleAddVisitorFormSubmit = async (e) => {
    e.preventDefault();
  ...
  const handleAddEmployeeFormSubmit = async (e) => {
    ...
    await axios.post(`/adminPage/addEmployee`, newEmployee);
  };
  ...
  const handleVisitorEditFormSubmit = async (e) => {
    ...
    await axios.put(`/updateVisit/${editVisitorId}`, editedVisitor);
  };

  const handleEmployeeEditFormSubmit = async (e) => {
    e.preventDefault();
    ...
    await axios.put(`/adminPage/updateEmployee/${editEmployeeId}`, editedEmployee);
  };
  ...
  //delete button
  const handleVisitorDeleteClick = async (visitorId) => {
    const newVisitors = [...visitors];
    ...
    await axios.delete(`/deleteVisit/${visitorId}`);
  };

  const handleEmployeeDeleteClick = async (employeeId) => {
    const newEmployees = [...employees];
    ...
    await axios.delete(`/adminPage/deleteEmployee/${employeeId}`);
  };
        ...
        <div className="admin_content">
          ...
          <form className="add_form" onSubmit={handleAddVisitorFormSubmit}>
            ...
            <input
              ...
              onChange={handleAddVisitorFormChange}
              value={addVisitorFormData.Password}
            />
            <input
              type="text"
              name="Time_In"
            ...
            <input
              ...
              onChange={handleAddVisitorFormChange}
              value={addVisitorFormData.Company}
            />
            <input
              type="text"
              name="Position"
